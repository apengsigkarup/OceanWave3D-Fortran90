SUBROUTINE DiffXXEvenCurvilinear_CD(var,varXX,Nxg,Nyg,Nzg,CompGrid,kappa,IndexX,StencilX,IndexY,StencilY)
...
REAL(KIND=long), DIMENSION(Nzg,Nxg,Nyg) :: var, varXX, vare, varn, varee, varnn, varen, vare2
...
DO i = 1, Nxg
	...
	END DO
END DO
END SUBROUTINE DiffXXEvenCurvilinear_CD
