SUBROUTINE AnalyticWaveMaker2D(izone,i0,i1,x,time,time0,Ea,Pa)
!
...
ELSEIF(IncWaveType==2)THEN
   ...
   Ea=RandomWave(izone)%eta(i0:i1,itime); Pa=RandomWave(izone)%Phis(i0:i1,itime)
END IF
