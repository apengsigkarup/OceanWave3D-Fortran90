SUBROUTINE StoreRealArray(Array,r1,r2,filename,formattype)
! By Allan P. Engsig-Karup.
USE Precision
USE Constants
USE DataTypes
IMPLICIT NONE
INTEGER :: r1, r2, formattype
REAL(KIND=long), DIMENSION(r1,r2) :: Array
...
SELECT CASE (formattype)
	...
	CASE DEFAULT
		...
		OPEN (unit=22, file=filename,form=form)
END SELECT
WRITE(22) r1, r2, Array
CLOSE(22)
END SUBROUTINE StoreRealArray
