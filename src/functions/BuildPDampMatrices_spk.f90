SUBROUTINE BuildPDampMatrices_spk(Nx,Ny,PDamp,FineGrid,alpha,beta)
!
...
!
  ...
  !ALLOCATE(PDamp%Lop%val(nnz),PDamp%Lop%irn(nnz),PDamp%Lop%icn(nnz)) coo format, for CSR is irn and icn shorter
...
END SUBROUTINE BuildPDampMatrices_spk
